 %HACK for “Package amsmath Warning Unable to redefine math accent \vec.” warninf
%from http://neu.davidmuench.de/getting-rid-of-package-amsmath-warning-unable-to-redefine-math-accent-vec/
\let\origvec\vec
...
%For appendix from https://tex.stackexchange.com/questions/179997/using-package-appendix-with-llncs
...
\titlerunning{Automated Analysis of Inference Attacks}% Part of RIGHT running header
% paper title
...
%\author{Daniel~Becker,~\IEEEmembership{Member,~IEEE,} and Andrew~Hines,~\IEEEmembership{Senior~Member,~IEEE}\\
% School of Computer Science\\University College Dublin, Ireland\\
%  Email: daniel@becker.ie,andrew.hines@ucd.ie}

\author{Daniel~Becker\inst{1}\orcidID{0000-1111-2222-3333} \and
Andrew~Hines\inst{1}\orcidID{1111-2222-3333-4444}} 
%
\authorrunning{Becker and Hines}
% First names are abbreviated in the running head.
% If there are more than two authors, 'et al.' is used.
%
\institute{School of Computer Science\\University College Dublin, Ireland\\
\email{daniel@becker.ie, andrew.hines@ucd.ie}}
...
\keywords{ Cryptographic~Protocol, Protocol~verification, Symbolic~Model, \\Property~Preserving~Encryption,  Inference, \tamarin{}}
...
\begin{enumerate}
	...
	\item \LExecution{Growth}: The dataset of encrypted values \enc{} grows correctly as new values are added and that the set of counters increments correctly as the population grows; these counters are used to model the distribution in the protected data.
\end{enumerate}
